    ...
    describe('#parse(:string)', function () {
        describe('when dealing with だ', function () {
            ...
            describe('〜じゃありません', function () {
                var basicAccentTests = {
                    '箸じゃありません': 'ハ＼シ　ジャアリマセ＼ン',
                    '橋じゃありません': 'ハシ＼　ジャアリマセ＼ン',
                    // skip: '本じゃありません': 'ホ＼ン　ジャアリマセ＼ン',
                    '本当じゃありません': 'ホントー　ジャアリマセ＼ン',
                    'お小遣いじゃありません': 'オコ＼ズカイ　ジャアリマセ＼ン',
                };
            ...
            describe('〜じゃない', function () {
                var basicAccentTests = {
                    '箸じゃない': 'ハ＼シ　ジャナ＼イ',
                    '橋じゃない': 'ハシ＼　ジャナ＼イ',
                    // skip: '本じゃない': 'ホ＼ン　ジャナ＼イ',
                    '本当じゃない': 'ホントー　ジャナ＼イ',
                    'お小遣いじゃない': 'オコ＼ズカイ　ジャナ＼イ',
                };
            ...
            describe('〜じゃなかった', function () {
                var basicAccentTests = {
                    '箸じゃなかった': 'ハ＼シ　ジャナ＼カッタ',
                    '橋じゃなかった': 'ハシ＼　ジャナ＼カッタ',
                    // skip: '本じゃなかった': 'ホ＼ン　　ジャナ＼カッタ',
                    '本当じゃなかった': 'ホントー　ジャナ＼カッタ',
                    'お小遣いじゃなかった': 'オコ＼ズカイ　ジャナ＼カッタ',
                };
